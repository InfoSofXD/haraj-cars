...
class _EditCarScreenState extends State<EditCarScreen> {
  ...
  void _populateFields() {
    ...
    _contactController.text = widget.car.contact;
    ...
    _engineController.text = widget.car.engineSize;
    _horsepowerController.text = widget.car.horsepower.toString();
    _exteriorColorController.text = widget.car.exteriorColor;
    _interiorColorController.text = widget.car.interiorColor;
    _doorsController.text = widget.car.doors.toString();
  ...
  Future<void> _saveCar() async {
    ...
    try {
      ...
      final car = Car(
        ...
        mainImage: imageUrl ?? widget.car.mainImage,
        otherImages:
            otherImageUrls.isNotEmpty ? otherImageUrls : widget.car.otherImages,
      ...
      final success = await supabaseService.updateCar(car);
